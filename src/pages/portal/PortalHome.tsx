    ...
    <div className="p-12 w-full max-w-6xl mx-auto h-full overflow-y-auto">
      ...
      <div className="bg-[#0B0F14] relative pl-4 border-l border-[#2A3442]">
        <div className="mb-8 relative">
          <div className="absolute -left-[21px] w-2.5 h-2.5 rounded-full bg-[#3B82F6] ring-4 ring-[#0B0F14]" />
        ...
        <div className="mb-8 relative">
          <div className="absolute -left-[21px] w-2.5 h-2.5 rounded-full bg-[#1D2430] border border-[#2A3442] ring-4 ring-[#0B0F14]" />

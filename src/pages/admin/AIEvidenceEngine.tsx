...
import {
  ...
  PenLine, Calendar, Clock, ShieldAlert, Brain, CheckCircle, XCircle,
  RotateCcw, Receipt, ArrowLeft,
} from 'lucide-react'
      ...
      <div className="p-6 lg:p-8">
        ...
        <div className="mb-6 grid grid-cols-1 gap-6 lg:grid-cols-3">
          ...
          <div className="glass-card rounded-2xl p-6 shadow-lg">
            <h3 className="mb-2 text-base font-semibold text-slate-900 dark:text-white">Overall Recommendation</h3>
            <p className={cn(
              'text-xl font-bold',
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button className="flex items-center justify-center gap-1.5 rounded-xl bg-emerald-600 px-3 py-2.5 text-xs font-semibold text-white hover:bg-emerald-700">
                <CheckCircle className="h-3.5 w-3.5" /> Approve
              </button>
              <button className="flex items-center justify-center gap-1.5 rounded-xl bg-red-600 px-3 py-2.5 text-xs font-semibold text-white hover:bg-red-700">
                <XCircle className="h-3.5 w-3.5" /> Reject
              </button>
              <button className="flex items-center justify-center gap-1.5 rounded-xl bg-amber-500 px-3 py-2.5 text-xs font-semibold text-white hover:bg-amber-600">
                <RotateCcw className="h-3.5 w-3.5" /> Return
              </button>
              <button
                onClick={() => navigate(`/admin/invoice-generator/${timesheet?.id}`)}
                className="flex items-center justify-center gap-1.5 rounded-xl gradient-accent px-3 py-2.5 text-xs font-semibold text-white"
              >
